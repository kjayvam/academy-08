            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        <h2>GET IN TOUCH</h2>
                        <p>고객은 매우 중요하며 고객의 문의에 대하여 다른 고객에게 이로운 정보를 제공합니다.</p>
                        <form id="contactForm">
                            <div class="row">
                                <div class="col-md-12">
				...
				<div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        ...
                        <ul>
                            <li>
                                <p><i class="fas fa-map-marker-alt"></i>Address: 서울 마포구 신촌로 176<br>(대흥동 12-20)중앙정보처리학원,<br>(04104)</p>
                            </li>
                            <li>
                                <p><i class="fas fa-phone-square"></i>Phone: <a href="tel:+1-888705770">+82-010 3395 3788</a></p>
                            </li>
                            <li>
                                <p><i class="fas fa-envelope"></i>Email: <a href="mailto:contactinfo@gmail.com">javasw@naver.com</a></p>
                            </li>
                        </ul>
                    </div>
                </div>
