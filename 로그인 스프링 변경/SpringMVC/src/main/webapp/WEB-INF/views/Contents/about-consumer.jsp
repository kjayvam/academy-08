...
<body>
    ...
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>ABOUT CONSUMER</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">ABOUT Consumer</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-frame"> <img class="img-fluid" src="images/guide_img01.jpg" alt="" />
                    </div>
                </div>
                <div class="col-lg-12">
                    <h2 class="noo-sh-title-top">착한가격업소란?</h2>
                    <p>착한 가격, 청결한 가게운영, 기분좋은 서비스 제공 으로 소비자에게 만족을 드리기 위해 정부와 지방자치단체가 선정한 우수업소 가 바로 착한가격업소 ’ 입니다.<br> 우리 동네에 있는 착한가격업소를 찾아보시고 안심하고 즐겁게 이용해 주세요.</p>
                </div>
				<div class="col-lg-12">
                    <div class="banner-frame"> <img class="img-fluid" src="images/guide_img02.jpg" alt="" />
                    </div>
                </div>
                <div class="col-lg-12">
                    <h2 class="noo-sh-title-top">착한가격업소 표찰과 스티커를 보셨나요?</h2>
                    <p>여러분이 살고 계신 동네에서 “ 착한가격업소 ” 표찰이나 스티커 를 본 적이 있으신가요?<br>
                    착한가격업소는 2011년부터 물가안정을 위해 가격이 저렴하지만 양질의 서비스를 제공하는 곳 을 정부가 지정한 우리 동네의 좋은 업소 입니다.<br>
                    착한가격업소 제도는 전반적 개인서비스 물가안정에 기여하고 서민이 많은 착한가격업소의 매출증대를 통해 서민경제 살리기에도 기여할 수 있습니다.<br>
                    지역상인과 소비자가 윈-윈(Win-Win) 할 수 있는 “착한가격업소”를 많이 애용해 주세요.</p>
                </div>
            </div>
        </div>
    </div>
