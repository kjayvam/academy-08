...
<head>
    ...
    <!-- 체크 js -->
    <script src="${pageContext.request.contextPath}/resources/js/modifyCheck.js"></script>
    <!-- 상단 메뉴 링크 js -->
        ...
        <div class="container">
            <div class="row new-account-login">
                <div class="col-sm-12 col-lg-12 mb-12">
                    ...
                    <form class="mt-3 collapse review-form-box" id="formRegister" name="modify" action="Member/modify" method="post">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="InputName" class="mb-0">*Name</label>
                                <input type="text" class="form-control" id="InputName" placeholder="<%= name %>" name="name" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="InputLastname" class="mb-0">*ID</label>
                                <input type="text" class="form-control" id="InputLastname" placeholder="<%= id %>" name="id" readonly>
                            </div>
                            
                            <div class="form-group col-md-6">
                                <label for="InputPassword1" class="mb-0">*Password</label>
                                <input type="password" class="form-control" id="InputPassword1" placeholder="Password" name="pw">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="InputPassword2" class="mb-0">*Password Check</label>
                            ...
                            <button type="button" class="btn hvr-hover" onclick="infoChange()">Register</button>
                    </form>
                </div>
            </div>
        </div>
