                ...
                <div class="row">
                        ...
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="#" onclick="wishlist()"> <i class="far fa-heart"></i> </a>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="#" onclick="modify()"><i class="fa fa-lock"></i> </a>
                                </div>
                                <div class="service-desc">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="#" onclick="logout()"><i class="fa fa-lock"></i> </a>
                                </div>
                                <div class="service-desc">
